...
// Номера в таблице API ядра десятичные: 78 и 79 (MD20.ASM PLUGIN_API_TABLE,
// 87 записей). Прежние 0x78/0x79 указывали за конец таблицы.
// i:A' - номер страницы плагина (как в +36 заголовка WMF)
#define _MNG0_PL 0x4E  // 78: страница плагина в #0000
#define _MNG8_PL 0x4F  // 79: страница плагина в #8000
