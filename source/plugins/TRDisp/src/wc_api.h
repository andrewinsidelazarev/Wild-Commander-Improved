...
#define _TXTPR 0x0B     // вывод текста в окне
                        //
...
#define _MEZZ 0x0C      // вывод сообщения в окне
                        // i:IX - SOW (структура должна лежать в #8000-#BFFF, #0000-#3FFF)
...
#define _MKfilenew 0x48 // создание файла в активном каталоге
...
{
    WC_WIND_STD = 0,
    WC_WIND_STD_HDR_TXT = 1,
    WC_WIND_STD_HDR_CUR = 2,
    WC_WIND_STD_FRM2 = 3,
    WC_WIND_HDR_TXT_FRM2 = 4,
    WC_WIND_TXT_CUR_FRM2 = 5,
    WC_WIND_TXT_FRM2 = 7,
    WC_WIND_HDR_TXT_CUR_FRM2 = 8
} WC_WIND_TYPE;
